...
//    console.log(this.symptoms);
    this.httpService.classify(this.symptoms).subscribe(
      result => {
        console.log(result);
      },
      error => {
  ...
  submitImg(){
    this.httpService.uploadImg(this.fileToUpload).subscribe(
      result => {
        console.log('here');
      },
      error => {
